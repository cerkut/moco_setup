...
#+begin_quote
Make and distribute CfP for conferences. See 
- https://github.com/NIME-conference/cookbook or its published version
- https://nime-conference.github.io/cookbook/ 
#+end_quote

** TODO migrate to markdown, and use actions for the tasks instead of org
...
They are here [[#Distribution]]

*** DONE Webpage @ https://www.movementcomputing.org/mocoXX-call-for-papers
CLOSED: [2019-12-02 Mon 07:59]
...
You will need the [[./README.org/Webpage]], the [[CfP]], and later for the preamble of the proceedings.
See 

- COST https://www.acm.org/publications/icps-series
  Major Change in ICPS Publishing Model as of 2024: Please see further details here:
  https://www.acm.org/publications/icps/organizer-guidance 
...
| Live Algorithms mailing list                      | list                                                                   |                                                 | LAM@JISCMAIL.AC.UK | LAM@JISCMAIL.AC.UK, | Reject    | 12/6/2018                |                         |
...
Even the ACM sponsorship won't help with metadata transfer, we have to find a way. 
