...
;; (org-map-entries (insert) "CfP")
(insert "THE BODY OF CFP")
(message-send-and-exit))
#+END_SRC

**** _alist
#+name: _alist
| NAME         | URL                                                       |                                    | APPRVL | CfP1: Date       | CfP2: Date | Notes          |
|--------------+-----------------------------------------------------------+------------------------------------+--------+------------------+------------+----------------|
...
| LURK         | list of lists | https://we.lurk.org  (update rest)                                 | announce@group.lurk.org | announce@group.lurk.org, | mailto:announce@group.lurk.org | Reject    |                  |            |       |


EACE	list	http://ii.tudelft.nl/~tjerk/EACE_website/contact.html	elly@cs.vu.nl	elly@cs.vu.nl,	mailto:elly@cs.vu.nl																				
music-ir (ircam)	list	http://listes.ircam.fr/wws/subscribe/music-ir	music-ir@listes.ircam.fr	music-ir@listes.ircam.fr,	mailto:music-ir@listes.ircam.fr																				
alife	list	http://lists.idyll.org/listinfo/alife-announce	 titus@idyll.org	 titus@idyll.org,																					
acma (australasian computer music association)	list	http://list.waikato.ac.nz/mailman/listinfo/acma-l	acma-l@list.waikato.ac.nz	acma-l@list.waikato.ac.nz,	mailto:acma-l@list.waikato.ac.nz	Moderator	12/6/2018																		
Computational Creativity Forum 	list	https://groups.google.com/forum/#!forum/computational-creativity-forum	computational-creativity-forum@googlegroups.com	computational-creativity-forum@googlegroups.com,	mailto:computational-creativity-forum@googlegroups.com	Reject	12/6/2018																		
cas (computer arts society), uk	list	https://www.jiscmail.ac.uk/cgi-bin/webadmin?A0=CAS	cas@jiscmail.ac.uk	cas@jiscmail.ac.uk,	mailto:cas@jiscmail.ac.uk																				
CEC	list	https://groups.google.com/forum/#!forum/cec-conference	cec-conference@googlegroups.com	cec-conference@googlegroups.com,	mailto:cec-conference@googlegroups.com	Reject	12/6/2018																		
DMRN	list	https://www.jiscmail.ac.uk/cgi-bin/webadmin?A0=DMRN-LIST	DMRN-LIST@JISCMAIL.AC.UK	DMRN-LIST@JISCMAIL.AC.UK,	mailto:DMRN-LIST@JISCMAIL.AC.UK	Reject	12/6/2018																		
MIAM	list	http://www.miam.itu.edu.tr/	miam@yahoogroups.com	miam@yahoogroups.com,																					
digital music research network (dmrn) list, uk	list		dmrn-list@jiscmail.ac.uk	dmrn-list@jiscmail.ac.uk,	mailto:dmrn-list@jiscmail.ac.uk																				
